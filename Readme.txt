...
In Test Case 2 wird der Fokus separat gesetzt obwohl dies aufgrund den automatischen Fokus nicht nötig ist. 
Dies wurde aber in der Testfallspezifikation so gefordert deshalb der separate Fokus


Test Case 3
Playwright unterstützt paralleles Testen. Um diese Feature nutzen zu können wurden die for-Schleife um die test-Funktion gelegt. 

Wenn gewünscht wäre auch eine großer Testfall möglich in dem man die for-Schleife innerhalb des Test benutzt. 
Dann müsste aber der timeout für diesen Test mit der Zeile test.setTimeout(180_000); erhöht werden.
